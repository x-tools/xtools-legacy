...
/*function outputSource( $msg ) {
   echo "<li>
   <a href=\"https://svn.cluenet.org/viewvc/tparis/trunk/bots/Tools/editsummary/index.php?view=markup\">View source</a>
   </li>";
}*/

if( !isset( $_GET['name'] ) ) {
   toDie( 'Welcome to the RfX Vote Calculator!<br />Kudos to SQL for the code!<br />
...
mysql_query($query, $tools);

$query = "CREATE  TABLE `rfap` (
  `name` VARCHAR(155) NOT NULL ,
  `md5` VARCHAR(255) NOT NULL ,
  `pulls` VARCHAR(45) NOT NULL ,
  `data` BLOB NOT NULL ,
...
} We're on labs now.  We don't need this restrictor.
*/
...
rev_user_text = '$name' AND page_namespace = '4'  AND page_title LIKE 'Requests_for_".$aorb."/%' AND page_title NOT LIKE '%$name%' AND page_title != 
