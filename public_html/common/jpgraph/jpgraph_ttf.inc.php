...
// Gnome Vera font
// Available from //www.gnome.org/fonts/
DEFINE("FF_VERA",18);
...
// Download fonts from 
// //www.webfontlist.com
// //www.webpagepublicity.com/free-fonts.html
...
// CONSTRUCTOR
	...
	$this->font_files=array(
	    ...
	    FF_VERA =>    array(FS_NORMAL	=>'DejaVuSans.ttf',   
				FS_BOLD		=>'DejaVuSans-Bold.ttf',   
				FS_ITALIC	=>'DejaVuSans-Italic.ttf.ttf',   
				FS_BOLDITALIC	=>'DejaVuSans-BoldItalic.ttf' ),
...
// PUBLIC METHODS	
	...
	if( !$fam ) {
	    JpGraphError::RaiseL(25046,$family);//("Specified TTF font family (id=$family) is unknown or does not exist. Please note that TTF fonts are not distributed with JpGraph for copyright reasons. You can find the MS TTF WEB-fonts (arial, courier etc) for download at //corefonts.sourceforge.net/");
	}
	$f = @$fam[$style];
